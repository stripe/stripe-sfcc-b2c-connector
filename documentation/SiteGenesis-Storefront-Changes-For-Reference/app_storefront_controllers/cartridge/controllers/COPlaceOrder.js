...
function start() {
    ...
    if (!saveCCResult) {
        return {
            error: true,
            PlaceOrderError: new Status(Status.ERROR, Resource.msg('confirm.error.technical', 'checkout', null))
        };
    }
    ...
    if (handlePaymentsResult.error) {
        return Transaction.wrap(function () {
			if(!empty(handlePaymentsResult.errormessage)) {
				errorMessage = handlePaymentsResult.errormessage;
			}
